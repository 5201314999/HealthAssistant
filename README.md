...
这是一款基于 HarmonyOS 的慢性病管理应用，专注于慢性病管理和用药提醒功能。应用采用**灵活的模板系统架构**，支持轻松扩展更多慢性病管理功能。数据完全离线存储，无需服务器后端，保护用户隐私。
...
├── config/
│   └── BuiltInTemplates.ets     # 内置模板配置（甲亢、糖尿病）
├── utils/
